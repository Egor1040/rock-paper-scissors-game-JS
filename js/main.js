...
// if (player1 == wordRock && player2 == wordRock || player1 == wordScissor && player2 == wordScissor || player1 == wordPaper && player2 == wordPaper) {
//     alert ('Ніхто не переміг, нічия');
// } else if (player1 == wordRock && player2 == wordScissor || player1 == wordScissor && player2 == wordPaper || player1 == wordPaper && player2 == wordRock) {
//     alert ('Переміг гравець #1');
// } else if (player1 == wordRock && player2 == wordPaper || player1 == wordPaper && player2 == wordScissor || player1 == wordScissor && player2 == wordRock ) {
...
// Гра фінальна версія
if (player1 == wordRock && player2 == wordRock) {
...
} else if (player1 == wordRock && player2 == wordScissor) {
...
} else if (player1 == wordPaper && player2 == wordRock) {
    alert ('Гравець #1 Переміг!!! Гравці Обрали #1 Папір - #2 Камінь');
} else if (player1 == wordRock && player2 == wordPaper) {
...
} else if (player1 == wordScissor && player2 == wordRock) {
